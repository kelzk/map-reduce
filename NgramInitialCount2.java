...
public class NgramInitialCount2 {
        ...
        public void reduce(Text key, Iterable<MapWritable> values, Context context) throws IOException, InterruptedException {
            ...
            for (Map.Entry<Text,IntWritable> entry : result.entrySet()){
                if (String.valueOf(entry.getKey()).equals("")){
                    context.write(key, new Text(String.valueOf(entry.getKey()) + String.valueOf(entry.getValue())));
                }
                if (!String.valueOf(entry.getKey()).equals("")){
                    context.write(key, new Text(String.valueOf(entry.getKey()) + " " + String.valueOf(entry.getValue())));
                }
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(NgramInitialCount2.class);
